...
/**
 * Representation of a deployer that can deploy a {@link MavenArtifact} to a
 * {@link Destination} using a {@link ProtocolConnector}.
 * 
...
public interface Deployer<T extends MavenArtifact> {
    ...
    /**
     * Deploys the specified {@link MavenArtifact} to the {@link Destination}
     * using the specified {@link ProtocolConnector}.
     * 
     * @param artifact
