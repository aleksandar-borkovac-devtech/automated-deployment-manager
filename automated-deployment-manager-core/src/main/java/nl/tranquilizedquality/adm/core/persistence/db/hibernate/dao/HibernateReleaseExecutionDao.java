 ...
 * @since 3 jun. 2011
 */
public class HibernateReleaseExecutionDao extends AbstractHibernateBaseDao<HibernateReleaseExecution, Long> implements
        ReleaseExecutionDao<HibernateReleaseExecution> {
