...
/**
 * Representation of a post release check plugin that can execute post release
 * checks.
 * 
...
public interface PostReleaseCheckPlugin extends Plugin {
     ...
     * @return Returns a {@link PostReleaseCheckResults} object containing the
     *         check results.
     */
    PostReleaseCheckResults executePostReleaseChecks(Map<String, String> parameters);

    /**
     * Initializes the plugin and eventually should register itself with the ADM
     * plugin manager. If not the plug-in will not be accessible through ADM.
     */
    void intialize();
