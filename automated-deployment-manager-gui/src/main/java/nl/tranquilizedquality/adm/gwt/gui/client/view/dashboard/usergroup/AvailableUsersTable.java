...
class AvailableUsersTable extends AbstractGridPanel {
	...
	/** Button to add the selected user to a {@link UserGroup}. */
	 ...
	 *            The search criteria.
	 */
	public AvailableUsersTable(final ClientUserSearchCommand sc, final UserGroupDetailsPanel detailsPanel) {
	...
	protected void initializeWidgets() {
		...
		addButton = new Button("Add User to group");
