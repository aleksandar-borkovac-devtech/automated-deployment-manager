/**
 * <pre>
 * Project: automated-deployment-manager-gui Created on: 3 okt. 2011 File: MavenModuleSelectionPanel.java
...
/**
 * Panel where modules can be looked up in and selected for creating an
 * artifact.
 * 
