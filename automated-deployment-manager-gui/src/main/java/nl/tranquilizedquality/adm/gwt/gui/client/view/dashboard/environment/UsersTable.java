...
/**
 * Grid where all users that are allowed to deploy to the environment are
 * displayed in.
 * 
 * @author Salomo Petrus (salomo.petrus@tr-quality.com)
 * @since Aug 24, 2012
 */
public class UsersTable extends AbstractRelationListTable<User, ClientUser> {
	...
	/** Details panel where the {@link Environment} is displayed in. */
	private final EnvironmentDetailsPanel detailsPanel;

	/**
	 * Default constructor.
	 */
	public UsersTable(final EnvironmentDetailsPanel detailsPanel) {
		setHeading("Deployers");
	...
	protected void initializeWidgets() {
		...
		removeButton = new Button("Remove User from environment");
