...
class UserPictureUploadWindow extends Window {
	...
	protected void onHide() {
		...
		personalDetailPanel.setModel(user);
	}
	...
	/**
	 * @param personalDetailPanel
	 *            the personalDetailPanel to set
	 */
	public void setPersonalDetailPanel(final PersonalDetailPanel personalDetailPanel) {
		this.personalDetailPanel = personalDetailPanel;
	}
