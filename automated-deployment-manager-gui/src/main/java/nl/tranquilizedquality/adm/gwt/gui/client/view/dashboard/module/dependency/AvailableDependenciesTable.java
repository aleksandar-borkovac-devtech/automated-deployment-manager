 ...
 * @since 8 feb. 2013
 */
public class AvailableDependenciesTable extends AbstractRelationListTable<MavenModule, ClientMavenModule> {
    ...
    public AvailableDependenciesTable(final MavenModuleDetailsPanel detailsPanel) {
        ...
        setId("maven-module-available-dependencies-tbl");
    ...
    protected void initializeWidgets() {
        ...
        addButton = new Button("Add Dependency");
        addButton.setId("add-available-dependency-btn");
            ...
            public void componentSelected(final ButtonEvent ce) {
                ...
                if (!selectedItems.isEmpty()) {
                    for (final BeanModel beanModel : selectedItems) {
                        final ClientMavenModule dependency = beanModel.getBean();
    ...
    protected String getPanelStateId() {
        return AvailableDependenciesTable.class.getName();
    }
